...
def extract_solution(solution_str: str) -> str:
    solution = last_boxed_only_string(solution_str)
    assert solution is not None
    return remove_boxed(solution)


def load_aime24_dataset(dataset_path: str | None, data_source: str, split: str):
...
if __name__ == "__main__":
    ...
    dataset = load_aime24_dataset(args.dataset_path, data_source, "test")
