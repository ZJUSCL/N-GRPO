...
class TokenizerManager:
    ...
    def convert_logprob_style(
        ...
        # latent rollout extras
        latent_embeds = getattr(recv_obj, "latent_thinking_embeds", None)
        if latent_embeds is not None:
            meta_info["latent_thinking_embeds"] = latent_embeds[recv_obj_index]
            meta_info["latent_thinking_mask"] = getattr(
                recv_obj, "latent_thinking_mask", [None]
            )[recv_obj_index]
            meta_info["latent_embeds_ratio"] = getattr(
                recv_obj, "latent_embeds_ratio", [None]
            )[recv_obj_index]
            meta_info["latent_entropy"] = getattr(
                recv_obj, "latent_entropy", [None]
            )[recv_obj_index]
            meta_info["latent_mix_explore_mask"] = getattr(
                recv_obj, "latent_mix_explore_mask", [None]
            )[recv_obj_index]
            meta_info["latent_topk_probs"] = getattr(
                recv_obj, "latent_topk_probs", [None]
            )[recv_obj_index]
            meta_info["latent_topk_indices"] = getattr(
                recv_obj, "latent_topk_indices", [None]
            )[recv_obj_index]
