...
class BatchTokenIDOut:
    ...
    # Latent rollout extras (defaults to empty lists to keep dataclass init order valid)
    latent_thinking_embeds: List[List[List[float]]] = dataclasses.field(default_factory=list)
    latent_thinking_mask: List[List[bool]] = dataclasses.field(default_factory=list)
    latent_embeds_ratio: List[List[float]] = dataclasses.field(default_factory=list)
    latent_entropy: List[List[float]] = dataclasses.field(default_factory=list)
    latent_mix_explore_mask: List[List[bool]] = dataclasses.field(default_factory=list)
    latent_topk_probs: List[List[List[float]]] = dataclasses.field(default_factory=list)
    latent_topk_indices: List[List[List[int]]] = dataclasses.field(default_factory=list)
