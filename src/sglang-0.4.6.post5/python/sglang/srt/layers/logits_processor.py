...
class LogitsProcessorOutput:
    ...
    # Optional vocab embedding weight (for latent rollout mixing)
    vocab_embedding_weight: Optional[torch.Tensor] = None
    ...
    latent_neighbor_probs: Optional[torch.Tensor] = None
    latent_neighbor_indices: Optional[torch.Tensor] = None
    latent_entropy: Optional[torch.Tensor] = None
    latent_thinking_embeds: Optional[torch.Tensor] = None
    # ==========
    ...
    def forward(
        ...
        if not logits_metadata.extend_return_logprob:
            ...
            return LogitsProcessorOutput(
                ...
                vocab_embedding_weight=lm_head.weight if hasattr(lm_head, "weight") else None,
                vocab_start_index=getattr(getattr(lm_head, "shard_indices", None), "org_vocab_start_index", None),
                vocab_end_index=getattr(getattr(lm_head, "shard_indices", None), "org_vocab_end_index", None),
