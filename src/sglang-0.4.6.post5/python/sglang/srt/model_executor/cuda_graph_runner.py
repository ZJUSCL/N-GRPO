    ...
    def replay(
        ...
        if isinstance(output, LogitsProcessorOutput):
            return LogitsProcessorOutput(
                ...
                vocab_embedding_weight=getattr(output, "vocab_embedding_weight", None),
                vocab_start_index=getattr(output, "vocab_start_index", None),
                vocab_end_index=getattr(output, "vocab_end_index", None),
                tp_world_size=getattr(output, "tp_world_size", None),
                tp_rank=getattr(output, "tp_rank", None),
            )
        else:
