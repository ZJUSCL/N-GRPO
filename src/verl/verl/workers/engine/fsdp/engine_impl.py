...
class FSDPEngine(BaseEngine):
    ...
    def _build_model_optimizer(self, config):
        ...
        with init_context(), warnings.catch_warnings():
            ...
            setattr(module, "hrpo_tokenizer", self.tokenizer)
            setattr(module, "latent_rollout_tokenizer", self.tokenizer)
            ...
            apply_hrpo_patch(module, hrpo_cfg=getattr(algo_cfg, "hrpo", None))
            apply_latent_rollout_patch(module, latent_cfg=getattr(algo_cfg, "latent_rollout", None))
